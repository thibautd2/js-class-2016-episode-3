      ...
      describe('equalTime', function() {
        ...
        describe('when given two date objects with the same values', function() {
          ...
          describe('when negated', function() {
            it('fails', function() {
              ...
              }).should.fail('expected ' + test.subject + ' to not equal ' + test.same);
            });
          });
        });
        describe('when given two date objects with different values', function() {
          it('fails', function() {
            ...
            }).should.fail('expected ' + test.subject + ' to equal ' + test.different);
          });
          describe('when negated', function() {
            it('passes', function() {
        ...
        describe('when given two date objects with the date values', function() {
          ...
          describe('when negated', function() {
            it('fails', function() {
              ...
              }).should.fail('expected Thu May 30 2013 to not equal Thu May 30 2013');
            });
          });
        });
      ...
      describe('when given two different date objects', function() {
        ...
        describe('when negated', function() {
          it('fails', function() {
            ...
            }).should.fail('expected Thu May 30 2013 not to be before Fri May 31 2013');
          });
        });
      });
      describe('when given two identical date objects', function() {
      ...
      describe('when given two different date objects', function() {
        ...
        describe('when negated', function() {
          it('fails', function() {
            ...
            }).should.fail('expected Fri May 31 2013 not to be after Thu May 30 2013');
          });
        });
      });
      describe('when given two identical date objects', function() {
    ...
    describe('beforeTime', function() {
      describe('when comparing two different times', function() {
        ...
        describe('when negated', function() {
          it('fails', function() {
            ...
            }).should.fail('expected ' + chai.datetime.formatTime(this.d1) + ' not to be before ' + chai.datetime.formatTime(this.d2));
          });
        });
      });
      describe('when comparing identical times', function() {
        ...
        it('fails', function() {
          ...
          }).should.fail('expected ' + chai.datetime.formatTime(this.d1) + ' to be before ' + chai.datetime.formatTime(this.d2));
        });
        describe('when negated', function() {
          it('passes', function() {
    ...
    describe('afterTime', function() {
      describe('when comparing two different times', function() {
        ...
        describe('when negated', function() {
          it('fails', function() {
            ...
            }).should.fail('expected ' + chai.datetime.formatTime(this.d1) + ' not to be after ' + chai.datetime.formatTime(this.d2));
          });
        });
      });
      describe('when comparing two identical times', function() {
        ...
        it('fails', function() {
          ...
          }).should.fail('expected ' + chai.datetime.formatTime(this.d1) + ' to be after ' + chai.datetime.formatTime(this.d2));
        });
        describe('when negated', function() {
          it('passes', function() {
